...
* Студент: [Иван Дейна](https://up.htmlacademy.ru/univer-html1/2/user/2426899).
* Наставник: `Алексей Владимирович
Самохвалов`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-univer-htmlcss-1/2426899-sedona-2) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
